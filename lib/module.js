...
var Module = (function (_super) {
    ...
    Module.prototype.openBill = function (params, callback) {
        ...
        this.db.getConnection(function (err, connection, cleanup) {
            ...
            connection.query("UPDATE bill SET isClosed=0 WHERE idBill=?", [id], function (err, rows) {
                cleanup();
                if (err) {
                    return callback(new DatabaseError(err));
                }
    ...
    Module.prototype.saveNewBill = function (params, callback) {
        ...
        async.waterfall([
            ...
            function (callback) {
                ...
                // Create bill
                connection.query("INSERT INTO bill SET createdDate = now(), total = ?, idUser = ?, isClosed = ?", [params.total, idUser, !params.archiveBill], function (err, res) {
